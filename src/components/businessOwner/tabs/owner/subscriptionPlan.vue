    ...
    <b-row>
        ...
        <b-card header-tag="header" footer-tag="footer">
          ...
          <div class="text1">
            <h5 class="font-weight-bold">
              Brige Africa Content <br />{{$t("businessowner.Intergration")}}
            </h5>
          </div>
      ...
      <b-col md="4" class="plan-2">
        ...
        <b-card header-tag="header" footer-tag="footer">
          ...
          <div class="text1">
            <h5 class="font-weight-bold">{{$t("businessowner.Subdomain_URL")}}L</h5>
            <p>http://website.com</p>
          </div>
          <div class="text1">
            <h5 class="font-weight-bold">{{$t("businessowner.Ticket_Support")}}</h5>
      ...
      <b-col md="4">
        <b-card header-tag="header" footer-tag="footer" class="mt-2 pt-1">
          ...
          <div class="text1">
            ...
            <p>{{$t("businessowner.email")}}, 
              {{$t("businessowner.phone")}}</p>
          </div>
