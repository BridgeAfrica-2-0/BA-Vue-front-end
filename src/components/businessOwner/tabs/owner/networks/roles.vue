  ...
  <b-container>
    ...
    <b-container class="b-bottom">
      ...
      <p class="a-text">
        ...
        {{ $t("businessowner.They_can_respond_to_the_delete_comments") }}, {{ $t("businessowner.Approve_posts") }}, {{ $t("businessowner.view_insights") }}, {{ $t("businessowner.manage_the_business_settings") }},
      ...
      <p class="a-text">
        ...
        {{ $t("businessowner.They_can_respond_to_and_delete_comments") }}, {{ $t("businessowner.Approve_posts") }}, {{ $t("businessowner.view_insights") }}
      </p>
    </b-container>
