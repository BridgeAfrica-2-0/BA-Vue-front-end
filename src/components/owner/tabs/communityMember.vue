                ...
                <b-col md="12" lg="6" xl="6">
                  <div class="e-name">
                    <b-row>
                      ...
                      >
                        <h6 class="follower m-15">{{ member.community >= 1000000 ? (member.community / 1000000) + 'M' : ( member.community >= 1000 ? (member.community/1000)+'K' : member.community )}} Community</h6>
                      </b-col>
                    </b-row>
                  </div>
                </b-col>
