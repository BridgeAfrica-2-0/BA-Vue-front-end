...
export default {
  ...
  mutations: {
    ...
    storeMobilePhones(state, payload) {
      state.userData[0].profile_about.basicInfo.mobilePhones = [...payload.mobilePhones];
    },
    ...
    storeSocialLinks(state, payload) {
      state.userData[0].profile_about.basicInfo.socialLinks = [...payload.socialLinks];
    },
    storeWorkPlace(state, payload) {
      if (payload.method === 'POST') {
        const newId = state.userData[0].profile_about.educationAndWorks.workPlaces.length;
        ...
        state.userData[0].profile_about.educationAndWorks.workPlaces[index] = payload.workPlace;
      }
    },
  ...
  actions: {
    deleteCover({ commit }) {
      return axios.delete('user/cover').then(({ data }) => {
        console.log(data);
      });
    },
    ...
    createContact({ commit }, payload) {
      console.log(payload);
      return axios
        .post('user/contact-create', { phone: payload.phone }, {})
        .then(res => {
    ...
    updateContact({ commit }, payload) {
      console.log(payload);
      return axios
        .post('user/contact-update/' + payload.id, { phone: payload.phone }, {})
        .then(res => {
          console.log(res.data);
        })
        .catch(err => {
    ...
    deleteContact({ commit }, payload) {
      console.log(payload);
      return axios
        .post('user/contact-delete/' + payload.id, {})
        .then(res => {
          console.log(res.data);
        })
        .catch(err => {
    ...
    CommunityBusiness({ commit }, businessId) {
      return axios.get('business/community/business/' + businessId).then(({ data }) => {
    ...
    CommunityPeople({ commit }, businessId) {
      return axios.get('business/community/people/' + businessId).then(({ data }) => {
      ...
      await axios
        ...
        .then(({ data }) => {
          ...
          context.commit('updateUserBiography', {
            info_access: data.data !== null ? data.data.biography[0].biography : 'private',
            description: data.data !== null ? data.data.biography[0].biography : 'No Description',
          });
          response_ = data;
        })
    ...
    async updateUserBiography(context, payload) {
      ...
      let response_ = null;
      await axios
        .post('userIntro/biography?' + 'biography=' + payload.description + '&value=' + payload.info_access)
    ...
    async loadUserProfileAbout({ commit }, payload) {
      ...
      await axios
        ...
        .then(response => {
          console.log('load user profile about response (2) successsss +++', response);
          if (!response) {
            console.log('Error from the server+++++++');
    ...
    async updateUserBasicInfosBirthDate(context, payload) {
      ...
      let response_ = null;
      await axios('userIntro/dob?' + 'dob=' + date, {
        method: 'POST',
        headers: {
          Accept: 'application/json',
        },
    ...
    async updateUserBasicInfosMobilePhones(context, payload) {
      ...
      const lastPhoneNumber = payload.mobilePhones;
      let response_ = null;
      await axios({
        method: 'post',
        ...
        .then(response => {
          console.log('edit user mobile phones response successsss (2) +++', response);
    ...
    async updateUserBasicInfosCurrentCity(context, payload) {
      ...
      let response_ = null;
      await axios('userIntro/addCurrentCity/11' + '?city=' + payload.currentCity, {
        method: 'POST',
        headers: {
          Accept: 'application/json',
        },
        ...
        .then(response => {
          console.log('edit user current city response successsss (2) +++', response);
          if (!response) {
            console.log('Error From The Server +++++++');
    ...
    async updateUserBasicInfosHomeTown(context, payload) {
      ...
      let response_ = null;
      await axios
        .post('userIntro/addHomeTown' + '?home_town=' + payload.homeTown, {
          method: 'POST',
          headers: {
            Accept: 'application/json',
          },
        ...
        .then(response => {
          console.log('edit user homeTown response successsss response (1) +++', response);
          if (!response) {
            console.log('Error From the server +++++++');
    ...
    async updateUserBasicInfosWebsites(context, payload) {
      ...
      await axios
        ...
        .then(response => {
          console.log('edit user websites response successsss response (1) +++', response);
          if (!response) {
            console.log('Error From The Server +++++++');
    ...
    async deleteUserBasicInfosWebsites(context, payload) {
      ...
      let response_ = null;
      await axios
        .delete('/userIntro/deleteWebLink/' + payload.id)
        .then(response => {
          console.log('edit user websites response (1) +++++++', response);
          if (response.status !== 200 && response.status !== 201) {
            console.log('Error From The Server');
    ...
    async updateUserBasicInfosSocialLinks(context, payload) {
      ...
      let response_ = null;
      await axios('userIntro/storeSocialLink' + '?socialLink=' + payload.socialLinks[payload.socialLinks.length - 1], {
        method: 'POST',
        data: {
          value: 'public',
        },
    ...
    async updateUserEducation(context, payload) {
      ...
      await axios(url, config)
        .then(response => {
          console.log('save/edit/delete user education response (1) +++++++', response);
          if (response.status !== 200 || response.status !== 201) {
            console.log('Error From The server +++++++');
        ...
        .then(response => {
          console.log('save/edit/delete user education response successsss response (2) +++', response);
          if (response.errors) {
