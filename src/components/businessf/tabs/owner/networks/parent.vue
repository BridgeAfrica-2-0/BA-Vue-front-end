  ...
  <div class="">
    <b-card title="" class="">
      <b-container class="a-center">
        ...
        <b-avatar :src="networkInfo[0].image" variant="primary" square rounded class="network-logo"> </b-avatar>
      ...
      <b-container>
        <b-form v-if="updateNetwork_form">
          ...
          <b-form-group
            ...
            class="mb-0"
          >
            <b-form-input id="tel-1" v-model="updateNetwork_form.phone1" name="phone1" type="tel" required>
            </b-form-input>
          </b-form-group>
          ...
          <b-form-group
            ...
            class="mb-0"
          >
            <b-form-input id="tel-2" v-model="updateNetwork_form.phone2" name="phone2" type="tel" required>
            </b-form-input>
          </b-form-group>
