  ...
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <div v-for="i in 4" :key="i">
          <div class="row ">
            ...
            <div class="col-4 text-end text-start bold">
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col"><h3 class="h3">8653536</h3></div>
              </div>
            ...
            <div class="col ">
              <div class="row ">
                ...
                <div class="col text-success p-0">5000 XAF</div>
                <div class="col p-0 text-success  text-center">10000 XAF</div>
                <div class="col-1 p-0">
                  <fas-icon
      ...
      <div class="col-3 color ">
        ...
        <button class="btn btn1 form-control shadow"><h3>CHECKOUT</h3></button>
        <br />
        <br />
      </div>
    </div>
