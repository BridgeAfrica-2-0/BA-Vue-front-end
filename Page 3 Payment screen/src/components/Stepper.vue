...
<div class="card mt-2 mx-auto" style="width:50rem;">
  <div class="card-body">
    ...
    <div class="col-sm p-4 ">
      <a href="#"  class="card-link text-uppercase float-right mr-5">Change</a>
    </div>
    </div>
       <div class="row">
    <div class="col-sm  p-4">
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <div class="buttons">
      <button v-show="stepflag==3" class="btn step-back" @click="backstep" disabled>Back</button>
      <button class="btn step-next btn-warning px-5 mt-5" @click="nextstep">Order</button>
      <button v-show="stepflag==3" class="btn step-complete " >Complete Step</button>
      <button v-show="stepflag==4" class="btn step-finish ">Finish</button>
    </div>
    </div>
  </div>
...
<div class="card mt-2 mx-auto" style="width:50rem;">
  <div class="card-body">
     <div class="row p-4">
    <div class="col">
     <img class="d-block w-50" src="@/assets/mtn.png" alt="Third slide">
    ...
    <div class="col">
     <input class="p-3" type="radio"  name="drone"  value="huey"
         checked>
    </div>
    </div>
     <div class="row p-4">
    <div class="col">
    <img class="d-block w-50" src="@/assets/orange_money.png" alt="Third slide">
   ...
   <input type="radio"  name="drone" value="huey" 
     ...
     <div class="row p-4">
    <div class="col">
   <img class="d-block w-25 " src="@/assets/gimac.jpg" alt="Third slide">
    ...
    <div class="col">
     <input type="radio"  name="drone" class="mt-3" value="huey"
         checked>
    </div>
    </div>
       <div class="row p-4">
   ...
   <div class="col">
    ...
    <div class="col">
           <button class="btn step-next btn-warning px-5 mt-5">Pay:00XXX</button>
