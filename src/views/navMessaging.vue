            ...
            <b-row class="chat-box border border-bottom-none">
              <b-col class="pr-0" v-if="rightSide">
                <div class="right border-right">
                  <b-row>
                    <b-col class="p-2">
                      <b-avatar class="d-inline-block profile-pic" variant="light" :src="getImage({
                        type: 'user',
                    ...
                    <b-col>
                      <b-icon style="font-size: 38px !important" @click="newMessage(true)"
                        class="h2 new-message  float-right pr-3" icon="pencil-square"></b-icon>
                    </b-col>
                  </b-row>

                  <b-row class="mt-12">
                    <b-col>
                      <b-tabs v-model="tabIndex" content-class="mt-12 ma-4 " fill pills>
                        <b-tab title="User" @click="getChatList({ type: 'user' })">
                          <!-- Users Chats Available  -->
                          <b-row class="pa-6">
                            <b-col class="mb-6 pb-6">
                              <input v-model="searchQueryUser" class="form-control input-background mb-2"
                                :placeholder="$t('general.Search_chat_list')" @keypress.enter="
                                  getChatList({
                                    type: 'user',
                          ...
                          ></b-spinner>
                            ...
                            <b-row v-for="(chat, index) in chatList" :key="index" :class="[
                              'p-2 message ',
                              {
                                messageSelected:
                            ...
                            ">
                              <b-col class="col-8">
                                <span style="display: inline-flex">
                                  <b-avatar class="d-inline-block" variant="light"
                                    :src="chatListImage(chat)"></b-avatar>
                              ...
                              <b-col class="col-4 text-center">
                                <span class="text-center float-right mt-n0">
                                  <b-dropdown variant="link" size="lg" toggle-class="text-decoration-none p-0" no-caret
                                    right>
                                ...
                                <small class="text-center">
                                  <b-badge variant="light" v-if="chat.message_count" class="count">{{ chat.message_count
                                    }}</b-badge>
                                </small>
                              </b-col>
                            </b-row>
                        ...
                        <b-tab title="Business" @click="getChatList({ type: 'business' })">
                          ...
                          <b-row class="pa-6">
                            <b-col class="mb-6 pb-6">
                              <input v-model="searchQueryBusiness" class="form-control input-background mb-2"
                                :placeholder="$t('general.Search_chat_list')" @keypress.enter="
                                  getChatList({
                                    type: 'business',
                          ...
                          ></b-spinner>
                            ...
                            ">
                              <b-col class="col-8">
                                <span style="display: inline-flex">
                                  <b-avatar class="d-inline-block profile-pic" variant="light"
                                    :src="chatListImage(chat)" square></b-avatar>
                        ...
                        <b-tab title="Network" @click="getChatList({ type: 'network' })">
                          ...
                          <b-row class="pa-6">
                            <b-col class="mb-6 pb-6">
                              <input v-model="searchQueryNetwork" class="form-control input-background mb-2"
                                :placeholder="$t('general.Search_chat_list')" @keypress.enter="
                                  getChatList({
                                    type: 'network',
                          ...
                          <div class="messages">
                            <div v-if="loader" class="text-center mt-12 pt-12">
                              <b-spinner variant="light" label="Spinning" class="centralizer"></b-spinner>
                            </div>
                            <b-row v-else v-for="(chat, index) in chatList" :key="index" :class="[
                              'p-2 message ',
                              {
                                messageSelected:
              ...
              <b-col v-if="newMsg == false && info == false && rightSide == false" class="p-0 back-image">
                <div class="chat-nav shadow" v-if="chatSelected.active">
                  <b-row class="desk" v-if="chatSelected.active">
                    <b-col class="col-1 mt-3 ma-4">
                      <b-icon @click="showMessages(true)" icon="arrow-left-square-fill" font-scale="1"
                        aria-hidden="true" class="primary"></b-icon>
                    </b-col>
                    <b-col class="col-3" @click="info = true">
                      <b-avatar variant="light" :src="chatListImage(chatSelected)" size="60"></b-avatar>
                    </b-col>
                    ...
                    <b-col class="col-2 text-center mr-6">
                      <b-icon v-b-toggle.collapse-1 class="msg-icon primary icon-size text-center" icon="search"
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card style="margin-top: -15px">
                    <input v-model="chatSearchKeyword" @keypress.enter="
                      histUserToUser({
                        receiverID: chatId,
                        keyword: chatSearchKeyword
                      })
                      " type="text" class="form-control input-background mb-6 pb-6" placeholder="Search... press enter" />
                  </b-card>
                </b-collapse>
                ...
                <section v-if="chatSelected.active" class="chats" style="margin-left: 1px" ref="feed">
                  <VuePerfectScrollbar class="scroll-area s-card" settings="{maxScrollbarLength: 60px}">
                    <div v-if="loader" class="text-center mt-12 pt-12">
                      <b-spinner variant="light" label="Spinning" class="spinner centralizer"></b-spinner>
                    </div>
                          ...
                          <b-col>
                            <p class="msg-text mt-0 text">
                              <span class="text-center float-right mt-n0">
                                <b-dropdown variant="link" size="lg" toggle-class="text-decoration-none p-0" no-caret
                                  ...
                                  <b-dropdown-item @click="deleteMessage(chat, userToUser, type)">
                                    Delete
                                  </b-dropdown-item>
                                </b-dropdown>
                              </span>
                            ...
                            <b>{{ chat.attachment }}</b> -->
                              ...
                              <span v-if="chat.post_details">
                                <small class="text-dark font-italic text-right"><i
                                    class="fas fa-share fa-xs pl-1"></i>Shared
                                  post</small><br />
                ...
                <div v-if="chatSelected.active" class="bottom mt-3">
                  ...
                  <b-row v-if="!checked">
                    <b-col cols="2" class="p-0">
                      <label for="file">
                        <b-icon for="file" class="msg-icon primary icon-size icon-top" icon="paperclip">
                        </b-icon>

                        <input style="display: none" type="file" id="file" ref="file" accept="image/*"
                    ...
                    <b-col cols="8" class="p-0">
                      ...
                      <b-form-input id="textarea" v-model="input" @keypress.enter="send" class="input-background"
                        placeholder="Enter a message..."></b-form-input>

                      <div class="wrapper">
                        <emoji-picker @emoji="append" :search="search">
                          <div class="emoji-invoker" slot="emoji-invoker" slot-scope="{ events: { click: clickEvent } }"
                            @click.stop="clickEvent">
                            <svg height="24" viewBox="0 0 24 24" width="24" class="svgg"
              ...
              <b-col v-if="info" class="chat-box border-bottom-none">
                ...
                <div class="info-bottom">
                  <b-avatar class="info-avatar" variant="light" :src="chatSelected.profile_picture"
                    size="200"></b-avatar>
                ...
                <div>
                  <ul>
                    <li>Options</li>
                    <li>
                      <b-row><b-col> Block Messages </b-col>
                        <b-col>
                          <b-form-checkbox v-model="checked" name="check-button" class="primary" switch>
                          </b-form-checkbox>
                        </b-col>
                      </b-row>
                    </li>
              ...
              <!-- New message -->
              <b-col v-if="newMsg == true && info == false && !rightSide" class="chat-box">
                <div class="back-image" style="margin-right: 07px">
                  <b-row>
                    ...
                    <b-col>
                      <b-form-input id="textarea" v-model="newSearchQuery" class="input-background" style="width: 100%"
                        :placeholder="`Type the name of the ${type}`" @input="onPressSearchNewChat"></b-form-input>
                      <br />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col class="new-msg-filter-list">
                      ...
                      <table v-else class="table">
                        <tbody v-if="type == 'user'">
                          <tr v-for="(user, index) in users" :key="index" class="p-2 message" @click="
                            selectedChat({
                              type: 'user',
                              chat: user,
                              id: user.id
                            ...
                            ">
                            <td>
                              <b-avatar class="d-inline-block" variant="light" size="30" :src="getImage({
                                type: 'user',
                        ...
                        <tbody v-if="type == 'business'">
                          <tr v-for="(biz, index) in bizs" :key="index" class="p-2 message" @click="
                            selectedChat({
                              type: 'business',
                              chat: biz,
                              id: biz.id
                        ...
                        <tbody v-if="type == 'network'">
                          <tr v-for="(network, index) in nets" :key="index" class="p-2 message" @click="
                            selectedChat({
                              type: 'network',
                              chat: network,
                              id: network.id
              ...
              <b-col class="col-4 pr-0">
                <div class="right border-right">
                  <b-row>
                    ...
                    <b-col>
                      <b-icon @click="newMessage(true)" class="new-message float-right h3 pr-6"
                        icon="pencil-square"></b-icon>
                    </b-col>
                  </b-row>
                      ...
                      <b-tabs v-model="tabIndex" content-class="mt-12 ma-4 " fill pills>
                        <b-tab title="User" @click="getChatList({ type: 'user' })">
                          ...
                          <b-row class="pa-6">
                            <b-col class="mb-6 pb-6">
                              <input v-model="searchQueryUser" class="form-control input-background mb-2"
                                :placeholder="$t('general.Search_chat_list')" @keypress="
                                  getChatList({
                                    type: 'user',
                                    keyword: searchQueryUser
                                  })
                              ...
                              <div v-if="chatList.length > 0">
                                ...
                                ">
                                  ...
                                  <b-col class="col-3 text-center">
                                    <span class="text-center float-right mt-n0">
                                      <b-dropdown variant="link" size="lg" toggle-class="text-decoration-none p-0"
                                        no-caret right>
                                        <template slot="button-content">
                                          <b><i class="fas fa-ellipsis-v"></i></b>
                                        </template>
                                    ...
                                    <small class="text-center">
                                      <b-badge variant="light" v-if="chat.message_count" class="count">{{
                                        chat.message_count
                                        }}</b-badge>
                                    </small>
                                  </b-col>
                ...
                <div class="chat-nav shadow" v-if="chatSelected.active">
                  <b-row class="desk" v-if="chatSelected.active">
                    <b-col class="col-3 m-auto" @click="info = true">
                      <b-avatar variant="light" :square="type == 'user' ? false : true"
                        :src="chatListImage(chatSelected)" size="60"></b-avatar>
                    </b-col>
                    ...
                    <b-col class="col-2 text-center m-auto">
                      <span style="cursor: pointer">
                        <b-icon v-b-toggle.collapse-1 class="msg-icon primary icon-size text-center"
                          icon="search"></b-icon>
                      </span>
                    </b-col>
                  </b-row>
                            ...
                            <b>{{ chat.attachment }}</b> -->
                              ...
                              <span v-if="chat.post_details">
                                <small class="text-dark font-italic text-right"><i
                                    class="fas fa-share fa-xs pl-1"></i>Shared
                                  post</small><br />
                                <img v-if="sharedImg(chat)" :src="sharedImg(chat)" class="sharedImg" />
                                <br />
                                <span class="font-italic">{{
                                  chat.post_details.content
                                  }}</span>
                  ...
                  <div style="width: 60%;">
                    ...
                    <b-row v-if="!checked">
                      ...
                      " icon="paperclip">
                          ...
                          <input style="display: none" type="file" id="file" accept="image/*" ref="file"
                            @change="handleFileUpload()" />
                        </label>
