<template>
  <div class="welcome" style=" overflow-x: hidden;">
    ...
    >
      <div>
        <h4 class="text-center username">Welcome On Bridge Africa</h4>
        <br />
        <br />
        ...
        <b-button variant="outline-primary" class="" @click="choseModal">
          Continue
        </b-button>
      </div>
    </b-modal>
    ...
    >
      <div>
        <form-wizard @on-complete="onComplete" color="#e75c18">
          ...
          <tab-content title="Business Indentity">
            <div class="form-card">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="username" class="username">Busness Name:</label
                    ><br />
                    <input
                      type="text"
                      name="username"
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="username" class="username">Keywords</label
                    ><br />
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="username" class="username">TomeZone:</label
                    ><br />
                    <select id="category" class="form-control text">
                      <option value="" selected="" disabled=""
...
export default {
  ...
  methods: {
    ...
    choseModal() {
      this.hideModal();
      console.log(this.useas);

      if (this.useas == "person") {
        console.log("hello");
