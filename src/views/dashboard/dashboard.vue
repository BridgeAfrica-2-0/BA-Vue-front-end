        ...
        <b-col md="3">
          <b-card class="text-center mt-2 p-2" v-if="!bussinessExist">
            <div class="">
              ...
              <p>
                Create your business profile so the people can search you, see your products, communicate with you and
                much more
              </p>
            ...
            <div class="">
              ...
              <b-row class="mt-2">
                <b-col cols="12" class="text-left text-size">
                  <p><b-icon icon="person-fill" variant="primary"></b-icon> view Profile</p>
                  <p>
                  ...
                  <p><b-icon icon="globe2" variant="primary"></b-icon> Visite Website</p>
                  <p>
