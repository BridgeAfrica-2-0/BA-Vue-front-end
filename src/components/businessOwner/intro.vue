    ...
    <b-card title="" header-tag="header" footer-tag="footer">
      ...
      <b-card-text>
        ...
        <p class="d-flex justify-content-start align-items-start">
          ...
          <span v-for="(keyword, index) in business_intro.keywords" :key="index">{{ keyword }}, </span>
        </p>
        <p class="d-flex justify-content-start align-items-start">
          ...
          <b-dropdown size="sm" variant="transperent">
            <template #button-content>
              ...
              <span class="ml-2">
                ...
                <span
                  v-if="
                    business_intro.business_open_hours[0].opening_time >= '00:00:00' &&
                      business_intro.business_open_hours[0].opening_time < '12:00:00'
                  "
                  >AM</span
                >
                <span v-else>PM</span> -
                ...
                <span
                  v-if="
                    business_intro.business_open_hours[0].closing_time >= '00:00:00' &&
                      business_intro.business_open_hours[0].closing_time < '12:00:00'
                  "
                  >AM</span
                >
                <span v-else>PM</span>)
            ...
            <b-dropdown-item v-for="(open_hours, index) in business_intro.business_open_hours" :key="index">
              {{ open_hours.day }}
              <span class="ml-2">
                ({{ open_hours.opening_time }}
                <!-- check if is AM or PM -->
                <span v-if="open_hours.opening_time >= '00:00:00' && open_hours.opening_time < '12:00:00'">AM</span>
                <span v-else>PM</span>
                - {{ open_hours.closing_time }}
                <span v-if="open_hours.closing_time >= '00:00:00' && open_hours.closing_time < '12:00:00'">AM</span>
                <span v-else>PM</span>)
              </span>
            </b-dropdown-item>
          </b-dropdown>
      ...
      >
        <GmapMarker :position="{ lat: business_intro.lat, lng: business_intro.lng }" />
      </GmapMap>
    </b-card>

    <b-modal id="bv-modal-example2" hide-footer title="Edit Address" v-model="edit2" size="lg">
      <b-form>
        {{ blec }}
        <b-row>
        ...
        <b-row>
          <b-form-group id="input-group-2" label="Phone Contact" label-for="input-2" label-size="sm" class="col-md-6">
            <b-form-input id="input-1" class="mt-1" v-model="form.phone" type="tel" required></b-form-input>
          </b-form-group>

          <b-form-group class="col-md-6" id="input-group-2" label="Business Email" label-for="input-2" label-size="sm">
            <b-form-input id="input-1" class="mt-1" v-model="form.email" type="email" required></b-form-input>
          </b-form-group>
        </b-row>
        ...
        <b-row>
          <div class="form-group col-md-6">
            ...
            <div class="col-md-12 pl-0 pr-0">
              <b-form-tags input-id="alias" v-model="form.keywords"></b-form-tags>
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <country-select v-model="form.country" :country="country" topCountry="CM" class="form-control text" />
          </div>
        </b-row>
        ...
        <b-row>
          <div class="form-group col-md-6">
            ...
            <region-select v-model="form.region" :country="country" :region="region" class="form-control text" />
          </div>
          <b-form-group id="input-group-2" label="City" label-for="input-2" label-size="sm" class="col-md-6">
            <b-form-input id="input-1" class="mt-1" v-model="form.city" type="text" required></b-form-input>
          </b-form-group>
        </b-row>
