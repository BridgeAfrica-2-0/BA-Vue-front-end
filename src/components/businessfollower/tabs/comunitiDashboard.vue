  ...
  <div class="lalaa">
    <div class=" border mt-2 ">
      ...
      <b-tabs lazy pills content-class="mt-3  f-left ">
        <b-tab active>
          <template slot="title"> People <span class="spa-color"> </span> </template>
            ...
            <b-row>
              <b-col>
                <b-tabs lazy fill pills content-class="mt-3  f-left m-up">
                  <b-tab active>
                    <template slot="title"> Followers <span class="spa-color"> </span> </template>

                    <div class="s-comcard"><People :people="people.people_followers" /></div>
                  </b-tab>

                  <b-tab>
                    <template slot="title"> Following <span class="spa-color"> </span> </template>
        ...
        <b-tab>
          <template slot="title"> Businesses <span class="spa-color"> </span> </template>
        ...
        <b-tab>
          <template slot="title"> Networks <span class="spa-color"> </span> </template>
