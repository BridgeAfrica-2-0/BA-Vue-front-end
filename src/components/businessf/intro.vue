  ...
  <div>
    <b-card title="" header-tag="header" footer-tag="footer">
      ...
      <b-card-text>
        ...
        <p><b-icon icon="geo-alt-fill" class="primary"></b-icon> Mokolo, Yaounde, Cameroon</p>
        <p><b-icon icon="link" class="primary"></b-icon> www.business.com</p>
        <p><b-icon icon="people-fill" class="primary"></b-icon> {{ business_intro.community }} Community</p>
        <p>
      ...
      <GmapMap :center="business_intro.position" :zoom="12" style="width:100%;  height: 250px;">
