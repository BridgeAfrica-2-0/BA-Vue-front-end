      ...
      <b-col cols="12">
        <div class="h-100 w-100">
          <div class="mx-auto text-center my-5">
            ...
            <p class="my-2 ">Follow people or business from the list below</p>
          </div>
        </div>
      </b-col>
    </b-row>
    <b-row class="mt-3">
      <b-col cols="12">
        <b-tabs content-class="mt-3">
          <b-tab title="Bussiness Around You" active>
            ...
            <span class="">
              ...
              <h5 class="m-0 font-weight-bolder d-inline-block ml-2">
                ...
                <span class="float-right mt-1">
                  <b-button variant="primary" class="mt-2">Following
              </b-button>
                </span>
              </p>
              <hr width="100%" />
            ...
            <span class="">
              ...
              <h5 class="m-0 font-weight-bolder d-inline-block ml-2">
                ...
                <span class="float-right mt-1">
                  <b-button variant="outline-primary" class="mt-2">Follow
              </b-button>
                </span>
              </p>
              <hr width="100%" />
          ...
          <b-tab title="People You may Know">
