...
if ($_POST['action'] != "") {
    ...
    if ($_POST['action'] == "login") {
        ...
        if (trim($_POST['pass']) == "" || filter_var(trim($_POST['email']), FILTER_VALIDATE_EMAIL) === false) {
    ...
    <div class="fpad-lg novpad">
        ...
        <?php } else { ?>
            ...
            if($freeMembershipPlanCheck !== false && !$disabledSignUps && !is_array($freeMembershipPlanCheck) && $freeMembershipPlanCheck->profile_type == 'free' && ($w['https_redirect'] ==1 && $w['website_url'] == $w['secure_url'])){ ?>
                ...
                <ul role="tablist" class="nav nav-tabs fpad nobpad nav-justified bold font-lg login-register-tabs">
                    <li class="active">
                        <a href="#login-tab-<?php echo $loginModalCounter;?>" rel="nofollow" aria-controls="t1" role="tab" data-toggle="tab" class="">
                            <?php echo $label['member_login_title'];?>
                        </a>
                    </li>
                    <li>
                        <a class="no-radius-bottom" href="#register-tab-<?php echo $loginModalCounter;?>" rel=" nofollow" aria-controls="t2" role="tab" data-toggle="tab">
                            <?php echo $label['express_login_register_new_account'];?>
                        </a>
                    </li>
                </ul>
                <div class="tab-content login-register-content nomargin">
                    <div role="tabpanel" class="login-tab tab-pane active" id="login-tab-<?php echo $loginModalCounter;?>">
                        <div class="module fpad-xl member-login-container">
                            <?php echo form("member_login", "", $w['website_id'], $w); ?>
                        </div>
						<div class="clearfix"></div>
                    </div>
                    <div role="tabpanel" class="register-tab tab-pane" id="register-tab-<?php echo $loginModalCounter;?>">
                        <div class="module fpad-xl member-login-container">
