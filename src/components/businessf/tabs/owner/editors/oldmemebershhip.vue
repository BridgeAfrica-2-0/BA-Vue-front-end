<template>
  <div class="container">
    <div>
      <b-row>
        <b-col class="f-left">
          <h6 class="d-inline-block">Membership Requests</h6>
        </b-col>
                      ...
                      <div class="e-name">
                        <b-row>
                          ...
                          <b-col
                            ...
                            class="mt-3 mt-xl-0"
                          >
                            <h6 class="follower">5K Follower</h6>
                          </b-col>
                        </b-row>
                      </div>
                    </b-col>
                    ...
                    <b-col lg="">
                      <div>
                        <b-row>
                          ...
                          >
                            <BtnCtaMessage :element="network" type="business" />
                          </b-col>
              ...
              <b-col cols="1">
                <span class="float-right a-dots">
                  ...
                  >
                    ...
                    <b-dropdown-item href="#"> Reject </b-dropdown-item>
                  </b-dropdown>
                </span>
              </b-col>
            </b-row>
