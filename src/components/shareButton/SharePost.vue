<template>
     <b-modal :id="id" hide-footer title="Write post">
        ...
        <div class="body mb-3 py-1">
           <img
              class="img-fluid"
              src="https://i.wifegeek.com/200426/4085d03b.jpg"
            />
            <p class="ft">
      ...
      <Button title="Publish"  styleClass="btn shadow  btn btn-bg flexx pobtn p-2 btn-primary btn-sm btn-block btn-primary btn-sm btn-block" /> 
