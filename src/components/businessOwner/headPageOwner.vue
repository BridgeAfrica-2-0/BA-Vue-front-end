      ...
      <div class="container-fluid logo-container">
        <b-row class="mt-md-2">
          <b-col cols="8" md="6" class="m-0 p-0">
            ...
            <a @click="selectlogo">
              <b-icon icon="camera-fill" class="avatar-header-icon btn cursor-pointer size"></b-icon>
            </a>
              ...
              <div class="text-box">
                <span>
                  <h6 class=" m-0 p-0 ml-3   profile-name">
                    ...
                    <br />
                    <span class="community"> {{ business_info.community }} Community </span>
                  </h6>
                </span>
              </div>
            </div>
          ...
          <b-col cols="4" md="6" class="">
            <div class="my-auto ">
              <span class="float-right">
                <b-button variant="primary" class="edit-btn  d-none d-md-inline" @click="selectCover">
                  <fas-icon class="mr-2" :icon="['fas', 'pencil-alt']" size="lg" /> Add Cover
                </b-button>
