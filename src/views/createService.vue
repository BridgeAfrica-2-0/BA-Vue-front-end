            ...
            <b-card title="Create A Service" tag="article" class="my-auto mx-auto">
              <div class="step-2">
                ...
                <b-form class="w-75 mx-auto">
                  ...
                  <b-form-group id="input-group-4">
                    <b-form-input id="input-4" v-model="name" type="text" placeholder="name" required />
                  </b-form-group>
                  <b-form-group id="input-group-4">
                    <b-form-input id="input-4" v-model="location" type="text" placeholder="location" required />
                  </b-form-group>
                  <b-form-textarea
                    id="textarea"
                    v-model="description"
                ...
                <br />
                <b-button type="submit" variant="outline-primary" v-on:click="add">
                  Create
                </b-button>
              </div>
            </b-card>
