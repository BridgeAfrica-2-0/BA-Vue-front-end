      ...
      <b-col>
        ...
        <span class="float-right">
          <b-dropdown size="sm" variant="outline " class="primary">
            ...
            <b-dropdown-item> {{ $t("profileowner.Edit")}} </b-dropdown-item>
            <b-dropdown-item>{{ $t("profileowner.Delete")}}</b-dropdown-item>
          </b-dropdown>
        </span>
        <p class="msg text">
          <read-more
        ...
        23
        <span @click="showReply" class="primary ml-2 reply"><b>{{ $t("profileowner.Reply")}}</b></span>
        <div v-if="reply">
          <b-row class="mt-2">
            <b-col cols="1">
              <b-avatar
            ...
            <b-col cols="11">
              <input :placeholder="$t('Post_a_Comment')" class="comment" type="text" />
