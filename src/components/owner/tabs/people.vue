  ...
  <div>
    <div class="s-cardd">
      <div
        ...
        v-for="item in isFollowers ? $store.getters.getCommunautyUserPost.followers : $store.getters.getCommunautyUserPost.followings"
        :key="item.id"
      >
        <b-row class="mb-1">
          <b-col md="3" cols="4" lg="3" class="my-auto">
            <b-avatar
              class="p-avater"
              variant="primary"
              :src="item.communautyProfilePicture"
            ></b-avatar>
          </b-col>
                ...
                <b-col md="12" lg="12" sm="12" cols="12">
                  <div class="e-name">
                    <b-row>
                      ...
                      >
                        <h6 class="follower">
                          {{ item.communautyNumberFollowers }}K Community
                        </h6>
                      </b-col>
                    </b-row>
                  </div>
