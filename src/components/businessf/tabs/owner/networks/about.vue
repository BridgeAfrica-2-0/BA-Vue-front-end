        ...
        <b-col>
          <b-card>
            <b-card-text>
              ...
              <p><b-icon icon="briefcase-fill" class="primary icon-size"></b-icon> Agriculture</p>
              <p><b-icon icon="search" class="primary icon-size"></b-icon> Chicken Seller</p>
              <p><b-icon icon="geo-alt-fill" class="primary icon-size"></b-icon> Mokolo, Yaounde, Cameroon</p>
              <p><b-icon icon="link" class="primary icon-size"></b-icon> www.business.com</p>
              <p><b-icon icon="people-fill" class="primary icon-size"></b-icon> 1.1M Community</p>
              <p>
