  ...
  <div>
    <div class="row">
      ...
      <div class=" col details">
        <h4>
          <b-link class="link">{{ $t("profileowner.Business_Name") }}</b-link>
        </h4>
        <p>
          <a href="">{{$t("profileowner.mywebsitecom")}}</a> <br />
          ...
          <strong>{{$t("profileowner.Location")}}:</strong> {{$t("profileowner.Neighbor")}}, {{$t("profileowner.City")}} {{$t("profileowner.Country")}} <br />
