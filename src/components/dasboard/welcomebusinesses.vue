    ...
    <splide-slide cl>
        ...
        <b-col md="8" cols="7"  lg="7" xl="5"  sm="5">
          <p class="textt">
            ...
            {{value.category}} 
              <br />  {{value.followers}} Community <br />   
            
            <span class="location"> <b-icon-geo-alt class="ico" ></b-icon-geo-alt> Douala cameroon  </span> <br /> 
            

              <read-more more-str="read more" :text="value.about_business" link="#" less-str="read less" :max-chars="15000" > </read-more>
          </p>
        </b-col>
        ...
        <b-col lg="12" xl="4" md="12" cols="12" sm="4">      
          <div class="s-button">
     <b-row>  <b-col md="4"  lg="4"  xl="12" sm="12" cols="4" class="mt-2 text-center">    
