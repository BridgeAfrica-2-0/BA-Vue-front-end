  ...
  <div class="bridge-home">
    ...
    <section class="product-section">
      <div class="container">
        ...
        <p class="section-description">With over 100 categories of products, easily shop from businesses in Cameroon
          anytime, anywhere.</p>
        <div class="button-group">
          ...
          <div class="button-end">
            ...
            <button class="filter-button">
               <!-- <img src="assets/home/grid_icon.svg" alt="Image 1"> -->
               <v-lazy-image src="assets/home/grid_icon.svg" alt="Image 1"/>
              </button>
          </div>
        </div>
        ...
        <div class="grid">
          <div v-for="(product, index) in products.slice(0, 8)" :key="index" class="grid-item">
            ...
            <div class="bottom-info">
              ...
              <button class="add-to-cart"><span style="font-size: 12px; font-weight: bold; ">Add to Cart</span><span
                  class="arrow-icon">
      ...
      <div class="container ba-business pt-5 pb-5">
        <div class="row">
          <div class="col-lg-6" data-aos="slide-right" data-aos-offset="70px" data-aos-duration="1500">
            <h3>
              <span class="m-header-color">Bridge Africa </span> <br> <span style="color: black;">{{
                $t("general.for_busineses") }} </span>
            </h3>
          ...
          <div class="col-lg-6 pl-5" data-aos="slide-left" data-aos-offset="70px" data-aos-duration="1500">
            <div>
              <video width="100%" style="object-fit:contain; border-radius: 10px;" controls
        ...
        <div class="row h-100">
          <div class="col-md-4 pt-2">
            <div class="p-3 about-p" data-aos="fade-up" data-aos-offset="70px" data-aos-duration="1500">
              <div class="mb-3">
                 <!-- <img src="assets/home/new_about_5.png" alt=""> -->
          ...
          <div class="col-md-4 pt-2">
            <div class="p-3 about-p" data-aos="fade-up" data-aos-offset="70px" data-aos-duration="1500">
              <div class="mb-3"> 
                <!-- <img src="assets/home/new_about_3.png" alt=""> -->
      ...
      <div class="container mt-0 p-0" data-aos="zoom-in-up" data-aos-offset="70px" data-aos-duration="1500">
        <div class="row mt-0">
          ...
          <div class="col-lg-8 mt-md-5 align-items-center pl-lg-5 pl-md-5 quote-form" id="quote">
            ...
            <div class="m-left">
              <h3>
                <span> {{ $t("general.let_help_u") }} </span> <span style="color: black;">{{
                $t("general.find_products_and_services") }}</span>
              </h3>
            ...
            <div class="">
              <div class=" m-auto mt-md-3  p-2 " style="border-radius: 15px;">
                <h3> <span> {{ $t("general.Tailor") }} </span>
                  <span style="color: black;">- {{ $t("general.Transformed") }} </span>
                </h3>
                <div class="d-block">
    ...
    <section style="background: #F3F3F3">
      ...
      <div class="container resources pt-5 pb-4">
        <div class="text-center">
          <h3>
            <span> {{ $t("general.digital_education") }} </span> <span style="color: black !important">{{
                $t("general.to_help_you_make_more_money") }} </span>
          </h3>
          <p class="pl-5 pr-5" style="color: black !important">
    ...
    <section class="bg-whitee">
      ...
      <div class="container pt-5 pb-5">
        <div class="text-left">
          <h3>
            <span> {{ $t("general.television_show") }} </span> <br> <span style="color: black !important">{{
                $t("general.from_our_television_show") }} </span>
          </h3>
        </div>
        <TelevisionShow />
      </div>
    ...
    <section class="bg-whitee">
      <div class="container mt-1 mt-md-5 mb-2 mb-md-5 pb-2 pb-md-5  pt-3 pt-md-5 " data-aos="zoom-in-up"
        data-aos-offset="70px" data-aos-duration="1500">
