  ...
  <div>
    ...
    <b-list-group-item class="d-flex align-items-center mb-4" style="border: none">
      <div class="datails t-left">
        <div class="row">
          <div class="media border-botmediatom mt-3 mb-4" v-for="workPlace in work" :key="workPlace.id">
            <div class="media-body">
              ...
              <b v-if="workPlace.end_year || workPlace.end_month || workPlace.end_day"
                ...
                {{ workPlace.end_year }}/{{ workPlace.end_month }}/{{ workPlace.end_day }}</b
              >
    ...
    <b-modal ref="edit-contact" id="edit" title="edit Workplace " @close="cancel" @ok="updatesave">
      ...
      this.$store
        ...
        .finally(() => {
          ...
          this.educationAndWorks = JSON.parse(
            JSON.stringify(this.$store.getters['profile/getProfileAboutEducationAndWorks']),
          );
          console.log(
            'Lewis Finally save/update/delete new workplace user +++++',
    ...
    edit(type, value) {
      switch (type) {
        ...
        case 'educations':
          ...
          this.index = this.educationAndWorks.educations.findIndex(education => {
        ...
        case 'professions':
          ...
          this.index = this.educationAndWorks.professions.findIndex(profession => {
