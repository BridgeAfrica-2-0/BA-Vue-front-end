            ...
            <b-card title="Modifications" tag="article" class="my-auto mx-auto">
              <div class="step-2">
                ...
                <b-form class="w-75 mx-auto">
                  ...
                  <b-form-group id="input-group-4">
                    <b-form-input id="input-4" v-model="name" type="text" :value="name" required />
                  </b-form-group>
                  <b-form-group id="input-group-4">
                    <b-form-input id="input-4" v-model="location" type="text" :value="location" required />
                  </b-form-group>
                  <b-form-textarea
                    id="textarea"
                    v-model="description"
                ...
                <br />
                <b-button type="submit" variant="outline-primary" v-on:click="modifier">
                  Modifier Le Contenu
                </b-button>
              </div>
            </b-card>
